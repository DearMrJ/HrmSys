...
import org.jkl.hrm.dao.provider.EmployeeDynaSqlProvider;
...
public interface EmployeeDao {
	...
	@Results({
		...
		@Result(column="DEPT_ID",property="dept",
			one=@One(select="org.jkl.hrm.dao.DeptDao.selectById",fetchType=FetchType.EAGER)),//立即加载
		@Result(column="JOB_ID",property="job",
			one=@One(select="org.jkl.hrm.dao.JobDao.selectById",fetchType=FetchType.EAGER))//立即加载
	})
	...
	@Results({
		...
		@Result(column="CREATEDATE",property="createDate",javaType=java.util.Date.class),
		@Result(column="DEPT_ID",property="dept",
			one=@One(select="org.jkl.hrm.dao.DeptDao.selectById",fetchType=FetchType.EAGER)),
		@Result(column="JOB_ID",property="job",
			one=@One(select="org.jkl.hrm.dao.JobDao.selectById",fetchType=FetchType.EAGER))
	})
