	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除部门",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${ctp }/dept/removeDept?ids=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		...
		<td class="main_locbg font2"><img src="${ctp}/img/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：部门管理 &gt; 部门查询</td>
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="deptform" method="post" id="deptform" action="${ctp}/dept/selectDept">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
				...
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					...
					<td><input type="checkbox" id="box_${stat.index}" value="${dept.id}"></td>
					 ...
					 <td>${dept.name }</td>
					  ...
					  <td>${dept.mnumber }</td>
					  <c:if test="${current_state==2}">
					 <td align="center" width="40px;"><a href="${ctp}/dept/updateDept?flag=1&id=${dept.id}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <jkl:myPager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctp}/dept/selectDept?pageIndex={0}"/>
	  </td></tr>
	</table>
