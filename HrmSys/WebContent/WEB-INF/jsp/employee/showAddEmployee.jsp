...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td class="main_locbg font2"><img src="${ctp}/img/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：员工管理  &gt; 添加员工</td>
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${ctp}/employee/addEmployee" id="employeeForm" method="post">
		 	<!-- 隐藏表单，flag表示添加标记 -->
		    ...
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			...
		    			<td class="font3 fftd">身&nbsp;份&nbsp;证&nbsp;：<input type="text" name="cardId" id="cardId" size="20"/></td>
		    		</tr>
		    		<tr>
