	    		   ...
	    		   if(checkedBoxs.length < 1){
	    			   ...
	    			   $.ligerDialog.confirm("确认要删除吗?","删除员工",function(r){
	    				   if(r){
	    					   // alert("删除："+ids.get());
	    					   // 发送请求
	    					   window.location = "${ctp}/employee/removeEmployee?ids=" + ids.get();
	    				   }
	    			   });
	    		   }
	    	   })
...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		...
		<td class="main_locbg font2"><img src="${ctp}/img/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：员工管理 &gt; 员工查询</td>
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="empform" method="post" id="empform" action="${ctp}/employee/selectEmployee">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	职位：
				...
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					...
					<td><input type="checkbox" id="box_${stat.index}" value="${employee.id}"></td>
					 ...
					 <td>${employee.id }</td>
					  ...
					  <c:if test="${current_state==2}">
					  <td align="center" width="40px;"><a href="${ctp}/employee/updateEmployee?flag=1&id=${employee.id}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <jkl:myPager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctp}/employee/selectEmployee?pageIndex={0}"/>
	  </td></tr>
	</table>
